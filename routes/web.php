...
Route::post('/companies/{company}/edit', [CompanyController::class, 'update'])->middleware('auth');
Route::post('/companies/{company}/del', [CompanyController::class, 'destroy'])->middleware('auth');
...
Route::post('/employees/{employee}edit', [EmployeeController::class, 'update'])->middleware('auth');
Route::post('/employees/{employee}/del', [EmployeeController::class, 'destroy'])->middleware('auth');
